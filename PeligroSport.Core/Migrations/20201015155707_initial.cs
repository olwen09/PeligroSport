        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Iso = table.Column<string>(maxLength: 4, nullable: true),
                    Name = table.Column<string>(maxLength: 80, nullable: true),
                    NiceName = table.Column<string>(maxLength: 80, nullable: true),
                    Iso3 = table.Column<string>(maxLength: 4, nullable: true),
                    NumCode = table.Column<string>(maxLength: 6, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AddressId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AddresLineOne = table.Column<string>(nullable: true),
                    AddresLineTwo = table.Column<string>(nullable: true),
                    City = table.Column<string>(nullable: true),
                    State = table.Column<string>(nullable: true),
                    CountryId = table.Column<int>(nullable: false),
                    ZipCode = table.Column<string>(nullable: true),
                    CreatorId = table.Column<string>(maxLength: 50, nullable: true),
                    ModifierId = table.Column<string>(maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
